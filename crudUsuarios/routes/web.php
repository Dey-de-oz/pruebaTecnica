...
/**Ruta para ver informacion de usuarios por nombre.*/
Route::post('/search',[PersonasController::class,'searchByName'])->name('personas.search');
/**Ruta para ver informacion de usuarios por rango de fechas.*/
Route::post('/range',[PersonasController::class,'searchByRange'])->name('personas.range');
